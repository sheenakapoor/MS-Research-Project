...
filename = 'CPPin20170708100000305SVMSGE1MD.nc'
...
# area_def = geometry.AreaDefinition.from_extent(area_id='azores',projection='+proj=eqc',shape=(1700,1295),area_extent=(-65,65, -5, 60),units='deg')
...
# print(my_cube)
# atmosphere_optical_thickness_due_to_cloud / (unknown) (latitude: 3636; longitude: 3636)
#     Dimension coordinates:
#          latitude                                             x                -
#          longitude                                            -                x

print(DS.variables)
# iris.save([my_cube], "CPPin20170708100000305SVMSGE1MD_1.nc", saver=iris.fileformats.netcdf.save)    #gives error, IOError: [Errno 13] Permission denied
